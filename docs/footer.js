/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v116 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v116";
  if (window.console && console.info) console.info("[footer bundle] FILE v116 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v98-file-v116");
      if (window.console && console.info){
