/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v117 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v117";
  if (window.console && console.info) console.info("[footer bundle] FILE v117 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v99-file-v117");
      if (window.console && console.info){
