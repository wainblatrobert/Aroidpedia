/* AROIDPEDIA footer bundle — built 2026-09-01 from FILE v203 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v203";
  if (window.console && console.info) console.info("[footer bundle] FILE v203 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v39-file-v203";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    function climReadout(ev){
      var t = ev.target, z = t && t.getAttribute && t.getAttribute("data-zone");
      var zone = (z && paths[z]) ? climAt(ev) : null;
      if (!zone){ hover.removeAttribute("data-on"); return; }
      hover.setAttribute("data-on", "1");
      hover.innerHTML = "";
      var em = document.createElement("em");
      em.textContent = zone.name;
      hover.appendChild(em);
      var tail = "";
      if (zone.t) tail += " \u00b7 " + zone.t[0] + " to " + zone.t[1] + " \u00b0C";
      if (zone.rh) tail += " \u00b7 " + zone.rh[0] + "\u2013" + zone.rh[1] + "% humidity";
      hover.appendChild(document.createTextNode(tail));
    }
    svg.addEventListener("mousemove", function(ev){
      if (currentView === "climate") climReadout(ev);
    });
    ...
    function apply(view){
      ...
      svg.classList.toggle("apgm--vclim", view === "climate");    /* v38 */
      if (view === "climate"){
      ...
      if (!subView && view !== "range" && view !== "climate" && hier && hier.places){
      ...
      order.forEach(function(z){
        ...
        var cov = !subView && view !== "range" && view !== "climate" && coveredBy(z);
    ...
    [["range", "Range"], ["climate", "Climate"],
     ["continents", "Continents"], ["regions", "Regions"],
     ["countries", "Countries"],
    ...
    svg.addEventListener("mouseover", function(ev){
      ...
      if (currentView === "climate") return;   /* v38: mousemove reads the band */
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v203");
      if (window.console && console.info){
