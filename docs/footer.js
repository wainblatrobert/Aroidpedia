/* AROIDPEDIA footer bundle — built 2026-08-15 from FILE v62 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v62";
  if (window.console && console.info) console.info("[footer bundle] FILE v62 (hosted footer.js)");
...
(function(){
  ...
  function render(host, genus, shapes, geo, g){
    ...
    function setHot(zone){
      ...
      if (!gr){ hover.removeAttribute("data-on"); return; }
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v48-file-v61");
      if (window.console && console.info){
