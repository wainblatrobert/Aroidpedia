/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v85 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v85";
  if (window.console && console.info) console.info("[footer bundle] FILE v85 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v68-file-v85");
      if (window.console && console.info){
