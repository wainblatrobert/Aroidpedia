/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v78 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v78";
  if (window.console && console.info) console.info("[footer bundle] FILE v78 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v61-file-v78");
      if (window.console && console.info){
