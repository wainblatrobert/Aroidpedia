/* AROIDPEDIA footer bundle — built 2026-09-01 from FILE v208 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v208";
  if (window.console && console.info) console.info("[footer bundle] FILE v208 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v149-file-v208");
      if (window.console && console.info){
