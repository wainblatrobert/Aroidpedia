/* AROIDPEDIA footer bundle — built 2026-09-01 from FILE v205 by build-footer-bundle v1.
...
(function(){
  ...
  var VERSION = "apgm-v41-file-v205";
  ...
  window.__apShapes = window.__apShapes || function(){
    ...
    function dec(T){
      ...
      var rb = {};
      Object.keys(T.rborders || {}).forEach(function(R){
        var segs = [];
        T.rborders[R].forEach(function(e){
        ...
        if (segs.length) rb[R] = segs;
      });
      return { shapes: shapes, rborders: rb, order: T.order, area: T.area,
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    var rbPaths = {}, rbSegs = shapes.rborders || {}, rbBuilt = 0;
    (function(){
      var rbHost = svgEl("g");
      Object.keys(rbSegs).forEach(function(R){
        var p = svgEl("path");
        p.setAttribute("class", "apgm-rb");
        /* v32: d is assembled on the first Regions apply, once the
           genus's painted footprint is known. */
        rbHost.appendChild(p);
        rbPaths[R] = p;
      });
      svg.appendChild(rbHost);
    })();
      ...
      if (view === "regions"){
        if (!rbBuilt){
          /* v32: THE BORDER FOLLOWS THE PAINTED FOOTPRINT. A segment
             ...
             (grower). Static per genus, so built once. */
          rbBuilt = 1;
          var ZSET = {}, CLIT = {};
          zones.forEach(function(z){
            ZSET[z] = 1;
          ...
          Object.keys(rbPaths).forEach(function(R){
            var d = "";
            (rbSegs[R] || []).forEach(function(seg){
              var on = !seg.z.length || seg.z.some(function(z2){
                return ZSET[z2] || CLIT[(HP[z2] || {}).country];
              });
              if (on) d += seg.d;
            });
            rbPaths[R].setAttribute("d", d);
          });
        }
        var rbLit = {};
        zones.forEach(function(z){
          var gr0 = groupMap[z];
          if (gr0) rbLit[gr0.name] = 1;
        });
        Object.keys(rbPaths).forEach(function(R){
          rbPaths[R].classList.toggle("apgm-rb--on", !!rbLit[R]);
        });
      }
      ...
      order.forEach(function(z){
        ...
        if (gr && (gr.merged || uniB) && fo > 0){
          if (view === "range"){
            ...
            paths[z].style.setProperty("--mst", "rgb(126,137,112)");
          } else {
        ...
        if (!subView){
          if (ghostLit[k]){
            ...
            el.style.setProperty("--mst", view === "countries"
              ? "rgb(126,137,112)" : compFill(ghostLit[k]));
          }
          return;
        }
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v205");
      if (window.console && console.info){
