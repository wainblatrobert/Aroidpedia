/* AROIDPEDIA footer bundle — built 2026-08-22 from FILE v157 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v157";
  if (window.console && console.info) console.info("[footer bundle] FILE v157 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v135-file-v157");
      if (window.console && console.info){
