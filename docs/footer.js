/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v135 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v135";
  if (window.console && console.info) console.info("[footer bundle] FILE v135 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v114-file-v135");
      if (window.console && console.info){
