/* AROIDPEDIA footer bundle — built 2026-08-25 from FILE v167 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v167";
  if (window.console && console.info) console.info("[footer bundle] FILE v167 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v139-file-v167");
      if (window.console && console.info){
