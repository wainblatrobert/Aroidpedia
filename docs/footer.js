/* AROIDPEDIA footer bundle — built 2026-08-29 from FILE v190 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v190";
  if (window.console && console.info) console.info("[footer bundle] FILE v190 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v26-file-v190";
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v190");
      if (window.console && console.info){
