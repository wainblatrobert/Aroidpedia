/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v72 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v72";
  if (window.console && console.info) console.info("[footer bundle] FILE v72 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v55-file-v72");
      if (window.console && console.info){
