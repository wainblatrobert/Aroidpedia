/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v71 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v71";
  if (window.console && console.info) console.info("[footer bundle] FILE v71 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v54-file-v71");
      if (window.console && console.info){
