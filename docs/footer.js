/* AROIDPEDIA footer bundle — built 2026-08-30 from FILE v194 by build-footer-bundle v1.
...
(function(){
  ...
  var VERSION = "apgm-v30-file-v194";
  ...
  window.__apShapes = window.__apShapes || function(){
    ...
    function dec(T){
      ...
      return { shapes: shapes, order: T.order, area: T.area,
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v194");
      if (window.console && console.info){
