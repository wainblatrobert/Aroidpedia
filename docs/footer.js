/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v74 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v74";
  if (window.console && console.info) console.info("[footer bundle] FILE v74 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v57-file-v74");
      if (window.console && console.info){
