/* AROIDPEDIA footer bundle — built 2026-08-30 from FILE v191 by build-footer-bundle v1.
...
(function(){
  ...
  var VERSION = "apgm-v27-file-v191";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    function apply(view){
      ...
      order.forEach(function(z){
        ...
        else                    fo = (SUB[z] || cov) ? 0 : ramp(gr.count, max);
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v191");
      if (window.console && console.info){
