/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v88 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v88";
  if (window.console && console.info) console.info("[footer bundle] FILE v88 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v71-file-v88");
      if (window.console && console.info){
