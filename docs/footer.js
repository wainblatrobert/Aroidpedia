/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v128 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v128";
  if (window.console && console.info) console.info("[footer bundle] FILE v128 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v110-file-v128");
      if (window.console && console.info){
