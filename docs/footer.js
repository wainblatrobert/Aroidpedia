/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v136 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v136";
  if (window.console && console.info) console.info("[footer bundle] FILE v136 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v115-file-v136");
      if (window.console && console.info){
