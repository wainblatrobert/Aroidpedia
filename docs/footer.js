/* AROIDPEDIA footer bundle — built 2026-08-26 from FILE v178 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v178";
  if (window.console && console.info) console.info("[footer bundle] FILE v178 (hosted footer.js)");
...
(function(){
    ...
    if (geo.hits.length || geo.continents.length || geo.unmapped.length ||
      ...
      order.forEach(function(c){
        ...
        seq.forEach(function(n){
          ...
          if (upTo(n) !== prev) m.setAttribute("data-restart", "1");
          run.appendChild(m);
          prev = n;
        });
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v146-file-v178");
      if (window.console && console.info){
