/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v79 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v79";
  if (window.console && console.info) console.info("[footer bundle] FILE v79 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v62-file-v79");
      if (window.console && console.info){
