/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v106 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v106";
  if (window.console && console.info) console.info("[footer bundle] FILE v106 (hosted footer.js)");
...
(function(){
  ...
  function buildMap(data, hits, doubtful, wash, subparent){
    ...
    order.forEach(function(name){
      ...
      if (subparent[name] && !onSet[name] && !ctxSet[name]) return;
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v88-file-v106");
      if (window.console && console.info){
