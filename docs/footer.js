/* AROIDPEDIA footer bundle — built 2026-08-28 from FILE v182 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v182";
  if (window.console && console.info) console.info("[footer bundle] FILE v182 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v18-file-v182";
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v147-file-v182");
      if (window.console && console.info){
