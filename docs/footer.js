/* AROIDPEDIA footer bundle — built 2026-08-22 from FILE v156 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v156";
  if (window.console && console.info) console.info("[footer bundle] FILE v156 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v134-file-v156");
      if (window.console && console.info){
