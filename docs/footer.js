/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v96 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v79-file-v96");
      if (window.console && console.info){
