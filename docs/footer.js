/* AROIDPEDIA footer bundle — built 2026-08-23 from FILE v162 by build-footer-bundle v1.
...
(function(){
  ...
  var VERSION = "apgm-v11-file-v162";
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v137-file-v162");
      if (window.console && console.info){
