/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v145 by build-footer-bundle v1.
...
(function(){
  ...
  var CFG = {
    ...
    CLAB_FS_PX   : 9.5,    /* country name type size */
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v123-file-v145");
      if (window.console && console.info){
