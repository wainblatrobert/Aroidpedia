/* AROIDPEDIA footer bundle — built 2026-08-25 from FILE v172 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v172";
  if (window.console && console.info) console.info("[footer bundle] FILE v172 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v15-file-v172";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    function apply(view){
      ...
      order.forEach(function(z){
        ...
        else if (subView)       fo = PARENTS[z]
                                       /* v15: the card's depth ladder - a fully-refined
                                          MIDDLE container (Sylhet under Moulvibazar) sits
                                          at .18, only the TOP of the chain drops to .07 */
                                       ? (residuals()[z] ? ramp(residuals()[z], max)
                                                         : (depthOf(z) >= 1 ? 0.18 : 0.07))
                                       : ramp(gr.count, max);
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v143-file-v172");
      if (window.console && console.info){
