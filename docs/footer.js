/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v90 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v73-file-v90");
      if (window.console && console.info){
