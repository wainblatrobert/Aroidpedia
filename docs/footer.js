/* AROIDPEDIA footer bundle — built 2026-08-29 from FILE v189 by build-footer-bundle v1.
...
(function(){
  ...
  var VERSION = "apgm-v25-file-v189";
      ...
      Object.keys(ghostPaths).forEach(function(k){
        ...
        if (!subView){
          if (ghostLit[k]){
            ...
            el.style.setProperty("--fam", ghostLit[k]);
          }
          return;
        }
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v189");
      if (window.console && console.info){
