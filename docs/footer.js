/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v149 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v149";
  if (window.console && console.info) console.info("[footer bundle] FILE v149 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v127-file-v149");
      if (window.console && console.info){
