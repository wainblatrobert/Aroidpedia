/* AROIDPEDIA footer bundle — built 2026-08-29 from FILE v187 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v187";
  if (window.console && console.info) console.info("[footer bundle] FILE v187 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v23-file-v187";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    var LABEL_DIR = { "Borneo": [-0.66, -0.75, 0.72], "Sumatra": [-1, 0.55],
                      "Java": [-0.35, 1], "Sulawesi": [0.89, -0.46, 0.9],
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v187");
      if (window.console && console.info){
