/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v144 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v144";
  if (window.console && console.info) console.info("[footer bundle] FILE v144 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v122-file-v144");
      if (window.console && console.info){
