/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v139 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v139";
  if (window.console && console.info) console.info("[footer bundle] FILE v139 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v118-file-v139");
      if (window.console && console.info){
