/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v143 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v143";
  if (window.console && console.info) console.info("[footer bundle] FILE v143 (hosted footer.js)");
...
(function () {
  ...
  var SUBNAV_ALL = {
    "/aroid-reproduction": [
      ...
      { label: "Dieffenbachia Reproduction", href: "/dieffenbachia-reproduction", pending: true },
      { label: "Dracunculus Reproduction",   href: "/dracunculus-reproduction" },
      { label: "Helicodiceros Reproduction", href: "/helicodiceros-reproduction", pending: true },
      { label: "Homalomena Reproduction",    href: "/homalomena-reproduction", pending: true },
  ...
  /* Filter once, here, so BOTH consumers - the desktop wire() and
     bindMobile() - see the same rows. Neither of them knows about the
     flag, and neither had to change. */
  var SUBNAV = {};
  Object.keys(SUBNAV_ALL).forEach(function (path) {
    var rows = SUBNAV_ALL[path].filter(function (r) { return !r.pending; });
    if (rows.length) SUBNAV[path] = rows;
  });
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v122-file-v143");
      if (window.console && console.info){
