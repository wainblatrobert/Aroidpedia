/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v89 by build-footer-bundle v1.
...
(function(){
  ...
  var apscHatchSeq = 0;
  function buildMap(data, hits, doubtful, wash){
  ...
  function render(mount, parsed, facts, data){
    ...
    var mapNode = isCultivarPost ? null
                : buildMap(data, geo.hits, geo.doubtful, geo.wash);
    ...
    (function(){
      ...
      box.appendChild(el("div","apsc-story__eyebrow","Field note"));
      if (title) box.appendChild(el("h2","apsc-story__title", title));
      if (bodyNodes.length){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v72-file-v89");
      if (window.console && console.info){
