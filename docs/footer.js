/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v132 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v132";
  if (window.console && console.info) console.info("[footer bundle] FILE v132 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v113-file-v132");
      if (window.console && console.info){
