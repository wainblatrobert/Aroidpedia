/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v107 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v107";
  if (window.console && console.info) console.info("[footer bundle] FILE v107 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v89-file-v107");
      if (window.console && console.info){
