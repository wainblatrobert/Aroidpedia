/* AROIDPEDIA footer bundle — built 2026-08-25 from FILE v171 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v171";
  if (window.console && console.info) console.info("[footer bundle] FILE v171 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v14-file-v165";
    ...
    function apply(view){
      ...
      order.forEach(function(z){
        ...
        if (view === "range")   fo = SUB[z] ? 0 : 0.8;
                                       ...
                                       ? (residuals()[z] ? ramp(residuals()[z], max) : 0.07)
                                       : ramp(gr.count, max);
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v143-file-v171");
      if (window.console && console.info){
