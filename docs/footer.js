/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v87 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v87";
  if (window.console && console.info) console.info("[footer bundle] FILE v87 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v70-file-v87");
      if (window.console && console.info){
