/* AROIDPEDIA footer bundle — built 2026-08-26 from FILE v177 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v177";
  if (window.console && console.info) console.info("[footer bundle] FILE v177 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v146-file-v177");
      if (window.console && console.info){
