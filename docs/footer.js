/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v105 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v105";
  if (window.console && console.info) console.info("[footer bundle] FILE v105 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v87-file-v105");
      if (window.console && console.info){
