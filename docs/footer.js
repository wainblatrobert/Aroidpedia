/* AROIDPEDIA footer bundle — built 2026-08-30 from FILE v193 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v193";
  if (window.console && console.info) console.info("[footer bundle] FILE v193 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v193");
      if (window.console && console.info){
