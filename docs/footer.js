/* AROIDPEDIA footer bundle — built 2026-08-30 from FILE v195 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v195";
  if (window.console && console.info) console.info("[footer bundle] FILE v195 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v31-file-v195";
  ...
  window.__apShapes = window.__apShapes || function(){
    ...
    function dec(T){
      ...
      Object.keys(T.rborders || {}).forEach(function(R){
        var d2 = "";
        T.rborders[R].forEach(function(i){
          var a = arcs[i];
          if (!a || a.length < 2) return;
          d2 += "M" + a.map(function(p){
            return p[0].toFixed(2) + " " + (-p[1]).toFixed(2);
          }).join("L");
        });
        if (d2) rb[R] = d2;
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    (function(){
      var rbHost = svgEl("g");
      Object.keys(shapes.rborders || {}).forEach(function(R){
        var p = svgEl("path");
        p.setAttribute("class", "apgm-rb");
        p.setAttribute("d", shapes.rborders[R]);
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v195");
      if (window.console && console.info){
