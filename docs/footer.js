/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v80 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v80";
  if (window.console && console.info) console.info("[footer bundle] FILE v80 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v63-file-v80");
      if (window.console && console.info){
