/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v126 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v126";
  if (window.console && console.info) console.info("[footer bundle] FILE v126 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v108-file-v126");
      if (window.console && console.info){
