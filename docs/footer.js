/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v103 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v103";
  if (window.console && console.info) console.info("[footer bundle] FILE v103 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v85-file-v103");
      if (window.console && console.info){
