/* AROIDPEDIA footer bundle — built 2026-08-31 from FILE v200 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v200";
  if (window.console && console.info) console.info("[footer bundle] FILE v200 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v36-file-v200";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    function setGhost(zone){
      ...
      em.textContent = zone;
      hover.appendChild(em);
      hover.appendChild(document.createTextNode(" · " + ghosts[zone] +
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v200");
      if (window.console && console.info){
