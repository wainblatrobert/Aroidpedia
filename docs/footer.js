/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v81 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v81";
  if (window.console && console.info) console.info("[footer bundle] FILE v81 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v64-file-v81");
      if (window.console && console.info){
