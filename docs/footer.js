/* AROIDPEDIA footer bundle — built 2026-08-30 from FILE v196 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v196";
  if (window.console && console.info) console.info("[footer bundle] FILE v196 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v32-file-v196";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    ((hier && hier.mapLabels) || []).forEach(function(nm){
      ...
      t.setAttribute("y", (ly + uy * pad * 0.4 + HOME[2] * 0.005).toFixed(2));
      t.setAttribute("text-anchor", ux > 0.25 ? "start" : ux < -0.25 ? "end" : "middle");
      t.setAttribute("font-size", (HOME[2] * 0.014).toFixed(2));
      t.textContent = nm;
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v196");
      if (window.console && console.info){
