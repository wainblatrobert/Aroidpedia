/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v121 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v121";
  if (window.console && console.info) console.info("[footer bundle] FILE v121 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v103-file-v121");
      if (window.console && console.info){
