/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v114 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v114";
  if (window.console && console.info) console.info("[footer bundle] FILE v114 (hosted footer.js)");
...
(function(){
  ...
  function buildMap(data, hits, doubtful, wash, subparent){
    ...
    order.forEach(function(name){
      ...
      /* v96: MULTI-COUNTRY SHAPES ARE NOT DRAWN AS BARE GROUND. Borneo,
         New Guinea and Sudan-South Sudan span countries that ALSO draw, so
         two translucent .apsc-base fills stacked over the same land and the
         overlap read as a third, brighter tone - Borneo looked lit next to
         Java, and Sudan glowed on a Philippine species. Lit or washed they
         still draw; as ground they are redundant with their countries. */
      if (MULTI[name] && !onSet[name] && !ctxSet[name]) return;
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v96-file-v114");
      if (window.console && console.info){
