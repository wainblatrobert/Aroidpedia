/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v140 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v140";
  if (window.console && console.info) console.info("[footer bundle] FILE v140 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v119-file-v140");
      if (window.console && console.info){
