/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v111 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v111";
  if (window.console && console.info) console.info("[footer bundle] FILE v111 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v93-file-v111");
      if (window.console && console.info){
