/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v133 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v133";
  if (window.console && console.info) console.info("[footer bundle] FILE v133 (hosted footer.js)");
...
(function () {
  ...
  var PAGES = [
    /* genus pages - these prefixes also cover their
       ...
       page is called.
       ⚠ The four newest guides (Dieffenbachia, Dracunculus,
       Helicodiceros, Homalomena) are deliberately ABSENT. This list is
       nav-glass-off and every entry must open with a banner section;
       those four have no banner, so listing them would leave the nav
       bar transparent over ordinary text. */
    "/alocasia",
    "/amorphophallus",
    "/anthurium",
    "/arisaema",
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v113-file-v133");
      if (window.console && console.info){
