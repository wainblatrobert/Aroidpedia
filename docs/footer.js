/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v102 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v102";
  if (window.console && console.info) console.info("[footer bundle] FILE v102 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v84-file-v102");
      if (window.console && console.info){
