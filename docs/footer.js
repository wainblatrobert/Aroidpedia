/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v127 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v127";
  if (window.console && console.info) console.info("[footer bundle] FILE v127 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v109-file-v127");
      if (window.console && console.info){
