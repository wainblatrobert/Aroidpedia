/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v100 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v100";
  if (window.console && console.info) console.info("[footer bundle] FILE v100 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v82-file-v100");
      if (window.console && console.info){
