/* AROIDPEDIA footer bundle — built 2026-09-01 from FILE v202 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v202";
  if (window.console && console.info) console.info("[footer bundle] FILE v202 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v38-file-v202";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    function climScan(im, ds){
      try {
        ...
        var px = g2.getImageData(0, 0, 720, 360).data, seen = {};
        for (var i = 0; i < px.length; i += 4){
          if (px[i + 3] < 128) continue;
          var zi = climByHex[climKey(px[i], px[i + 1], px[i + 2])];
          if (zi) seen[zi] = (seen[zi] || 0) + 1;
        }
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v202");
      if (window.console && console.info){
