/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v134 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v134";
  if (window.console && console.info) console.info("[footer bundle] FILE v134 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v113-file-v134");
      if (window.console && console.info){
