/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v118 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v118";
  if (window.console && console.info) console.info("[footer bundle] FILE v118 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v100-file-v118");
      if (window.console && console.info){
