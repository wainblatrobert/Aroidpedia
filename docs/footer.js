/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v123 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v123";
  if (window.console && console.info) console.info("[footer bundle] FILE v123 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v105-file-v123");
      if (window.console && console.info){
