/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v150 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v150";
  if (window.console && console.info) console.info("[footer bundle] FILE v150 (hosted footer.js)");
...
(function(){
  ...
  function buildMap(data, hits, doubtful, wash, subparent){
    ...
    (function(){
      ...
      if (Object.keys(islandSet).length){
        ...
        Object.keys(islandSet).forEach(function(n){
          if (PATHBB[n]) entries.push({ text:n, bb:PATHBB[n], shapes:[n] });
        });
      } else {
        var by = {};
    ...
    function show(name, lit, doubt){
      ...
      var up = (HIER3[name] || {}).parent;
      readout.innerHTML = esc(name) +
        (up && up !== name ? "<i>&nbsp;&ndash;&nbsp;" + esc(up) + "</i>" : "") +
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v128-file-v150");
      if (window.console && console.info){
