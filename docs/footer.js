/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v131 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v131";
  if (window.console && console.info) console.info("[footer bundle] FILE v131 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v112-file-v131");
      if (window.console && console.info){
