/* AROIDPEDIA footer bundle — built 2026-08-28 from FILE v184 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v184";
  if (window.console && console.info) console.info("[footer bundle] FILE v184 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v20-file-v184";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    var LABEL_DIR = { "Borneo": [0.55, -1], "Sumatra": [-1, 0.55],
    ...
    function coveredBy(z){
      var C = (HP[z] || {}).country;
      if (C && C !== z && (paths[C] || dpaths[C])) return true;
      var m = MULTI[z];
      if (m && m.countries && m.countries.some(function(c){
        return c !== z && (paths[c] || dpaths[c]); })) return true;
      return false;
    }
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v184");
      if (window.console && console.info){
