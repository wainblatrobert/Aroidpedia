/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v93 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v93";
  if (window.console && console.info) console.info("[footer bundle] FILE v93 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v76-file-v93");
      if (window.console && console.info){
