/* AROIDPEDIA footer bundle — built 2026-08-22 from FILE v159 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v159";
  if (window.console && console.info) console.info("[footer bundle] FILE v159 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v137-file-v159");
      if (window.console && console.info){
