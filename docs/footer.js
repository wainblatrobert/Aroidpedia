/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v83 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v83";
  if (window.console && console.info) console.info("[footer bundle] FILE v83 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v66-file-v83");
      if (window.console && console.info){
