/* AROIDPEDIA footer bundle — built 2026-08-22 from FILE v158 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v158";
  if (window.console && console.info) console.info("[footer bundle] FILE v158 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v136-file-v158");
      if (window.console && console.info){
