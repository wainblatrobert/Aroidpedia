/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v94 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v94";
  if (window.console && console.info) console.info("[footer bundle] FILE v94 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v77-file-v94");
      if (window.console && console.info){
