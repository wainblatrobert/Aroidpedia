/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v86 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v86";
  if (window.console && console.info) console.info("[footer bundle] FILE v86 (hosted footer.js)");
...
(function(){
  ...
  function resolveRegions(tags, distText, data){
    ...
    /* v69: A COUNTRY IS THE LAST CHOICE FOR THE WASH (user 8.16.26,
       ...
       regions. */
    var COUNTRY_PARENT = {};
    ["Australia","Benin","Bolivia","Colombia","Costa Rica","Ecuador",
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v69-file-v86");
      if (window.console && console.info){
