/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v68 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v68";
  if (window.console && console.info) console.info("[footer bundle] FILE v68 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v51-file-v68");
      if (window.console && console.info){
