/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v70 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v70";
  if (window.console && console.info) console.info("[footer bundle] FILE v70 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v53-file-v70");
      if (window.console && console.info){
