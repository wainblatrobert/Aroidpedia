/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v112 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v112";
  if (window.console && console.info) console.info("[footer bundle] FILE v112 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v94-file-v112");
      if (window.console && console.info){
