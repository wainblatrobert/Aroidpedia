/* AROIDPEDIA footer bundle — built 2026-08-25 from FILE v170 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v170";
  if (window.console && console.info) console.info("[footer bundle] FILE v170 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v142-file-v170");
      if (window.console && console.info){
