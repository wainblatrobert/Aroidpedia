/* AROIDPEDIA footer bundle — built 2026-08-26 from FILE v174 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v144-file-v174");
      if (window.console && console.info){
