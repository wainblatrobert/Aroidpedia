/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v65 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v65";
  if (window.console && console.info) console.info("[footer bundle] FILE v65 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v49-file-v65");
      if (window.console && console.info){
