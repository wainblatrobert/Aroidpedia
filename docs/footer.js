/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v99 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v99";
  if (window.console && console.info) console.info("[footer bundle] FILE v99 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v81-file-v99");
      if (window.console && console.info){
