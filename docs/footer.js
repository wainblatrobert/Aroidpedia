/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v129 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v129";
  if (window.console && console.info) console.info("[footer bundle] FILE v129 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v111-file-v129");
      if (window.console && console.info){
