/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v76 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v76";
  if (window.console && console.info) console.info("[footer bundle] FILE v76 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v59-file-v76");
      if (window.console && console.info){
