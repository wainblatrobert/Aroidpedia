/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v138 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v138";
  if (window.console && console.info) console.info("[footer bundle] FILE v138 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v117-file-v138");
      if (window.console && console.info){
