/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v84 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v84";
  if (window.console && console.info) console.info("[footer bundle] FILE v84 (hosted footer.js)");
...
(function(){
  ...
  function render(mount, parsed, facts, data){
    ...
    var mapNode = buildMap(data, geo.hits, geo.doubtful, geo.wash);
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v67-file-v84");
      if (window.console && console.info){
