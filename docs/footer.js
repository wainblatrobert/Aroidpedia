/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v148 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v148";
  if (window.console && console.info) console.info("[footer bundle] FILE v148 (hosted footer.js)");
...
(function(){
  ...
  function buildMap(data, hits, doubtful, wash, subparent){
    ...
    order.forEach(function(name){
      ...
      if (onSet[name] || ctxSet[name] || islandSet[name]) SHAPEEL[name] = p;
    ...
    (function(){
      ...
      if (Object.keys(islandSet).length){
        ...
        Object.keys(by).forEach(function(c){
          entries.push({ text:c, bb:by[c].bb, shapes:by[c].shapes });
        });
      }
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v126-file-v148");
      if (window.console && console.info){
