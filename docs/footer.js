/* AROIDPEDIA footer bundle — built 2026-08-26 from FILE v173 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v173";
  if (window.console && console.info) console.info("[footer bundle] FILE v173 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v143-file-v173");
      if (window.console && console.info){
