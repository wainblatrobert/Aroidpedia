/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v152 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v152";
  if (window.console && console.info) console.info("[footer bundle] FILE v152 (hosted footer.js)");
...
(function(){
  ...
  function buildMap(data, hits, doubtful, wash, subparent){
    ...
    (function(){
      ...
      if (!entries.length || entries.length > CFG.CLAB_MAX) return;
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v130-file-v152");
      if (window.console && console.info){
