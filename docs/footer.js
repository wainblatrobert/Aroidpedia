/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v77 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v77";
  if (window.console && console.info) console.info("[footer bundle] FILE v77 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v60-file-v77");
      if (window.console && console.info){
