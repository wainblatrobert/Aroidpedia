/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v122 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v122";
  if (window.console && console.info) console.info("[footer bundle] FILE v122 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v104-file-v122");
      if (window.console && console.info){
