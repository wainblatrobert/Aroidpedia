/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v69 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v69";
  if (window.console && console.info) console.info("[footer bundle] FILE v69 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v51-file-v69");
      if (window.console && console.info){
