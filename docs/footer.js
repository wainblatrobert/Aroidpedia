/* AROIDPEDIA footer bundle — built 2026-08-25 from FILE v169 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v141-file-v169");
      if (window.console && console.info){
