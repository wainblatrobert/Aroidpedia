/* AROIDPEDIA footer bundle — built 2026-08-15 from FILE v61 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v61";
  if (window.console && console.info) console.info("[footer bundle] FILE v61 (hosted footer.js)");
