/* AROIDPEDIA footer bundle — built 2026-08-27 from FILE v179 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v179";
  if (window.console && console.info) console.info("[footer bundle] FILE v179 (hosted footer.js)");
...
(function () {
  ...
  var SUBNAV_ALL = {
    /* v135: THE MORPHOLOGY FLYOUT. Two rows, and only two on
       purpose - see the NAV v135 banner at the top of this file for
       why this list does NOT follow the no-filtering ruling that
       governs the reproduction list below it.
       ⚠ ADD A GENUS ONLY WHEN ITS GUIDE IS PUBLISHED. Seventeen more
