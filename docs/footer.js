/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v82 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v82";
  if (window.console && console.info) console.info("[footer bundle] FILE v82 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v65-file-v82");
      if (window.console && console.info){
