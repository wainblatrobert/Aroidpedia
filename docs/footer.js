/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v92 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v75-file-v92");
      if (window.console && console.info){
