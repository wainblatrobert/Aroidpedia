/* AROIDPEDIA footer bundle — built 2026-08-23 from FILE v161 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v161";
  if (window.console && console.info) console.info("[footer bundle] FILE v161 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v10-file-v161";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    svg.addEventListener("click", function(ev){
      ...
      if (!z){ closePanel(); setHot(null); return; }
      openPanel(z, !paths[z]);
    });
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v137-file-v161");
      if (window.console && console.info){
