/* AROIDPEDIA footer bundle — built 2026-08-23 from FILE v163 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v163";
  if (window.console && console.info) console.info("[footer bundle] FILE v163 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v12-file-v163";
      ...
      if (view === "countries"){
        ...
        if (HC){
          ...
          Object.keys(byC).forEach(function(c){
            ...
            byC[c].forEach(function(z){
              m[z] = { name: c, count: n, merged: byC[c].length > 1 ? 1 : 0 };
            });
          });
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v137-file-v163");
      if (window.console && console.info){
