/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v95 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v95";
  if (window.console && console.info) console.info("[footer bundle] FILE v95 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v78-file-v95");
      if (window.console && console.info){
