/* AROIDPEDIA footer bundle — built 2026-08-29 from FILE v185 by build-footer-bundle v1.
...
(function(){
  ...
  var VERSION = "apgm-v21-file-v185";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    /* v21: Borneo's old [0.55,-1] (north-east) landed the text on the
       ...
       Vietnam - north-west. */
    var LABEL_DIR = { "Borneo": [-0.8, -0.95], "Sumatra": [-1, 0.55],
    ...
    ((hier && hier.mapLabels) || []).forEach(function(nm){
      ...
      var pad = HOME[2] * 0.02;
      var lx = cx + ux * (hw + pad) * 1.06, ly = cy + uy * (hh + pad) * 1.06;
      var line = svgEl("line");
    ...
    /* a handful of points ON the unit's own ground - a bbox centre
       ...
       fills, capped at 8. */
    function covProbe(z){
      if (covPt[z] !== undefined) return covPt[z];
    ...
    function covPaints(c, z){
      ...
      if (!el) return false;
      if (paths[c] && SUB[c]) return false;    /* fill-0 in the flat views */
      var pts = covProbe(z);
    ...
    function apply(view){
      ...
      Object.keys(ghostPaths).forEach(function(k){
        ...
        if (groupMap[k] && groupMap[k].__ghost) delete groupMap[k];
        if (!subView) return;
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v185");
      if (window.console && console.info){
