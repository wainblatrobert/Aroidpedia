/* AROIDPEDIA footer bundle — built 2026-08-17 from FILE v91 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v74-file-v91");
      if (window.console && console.info){
