/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v73 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v73";
  if (window.console && console.info) console.info("[footer bundle] FILE v73 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v56-file-v73");
      if (window.console && console.info){
