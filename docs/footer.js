/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v137 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v137";
  if (window.console && console.info) console.info("[footer bundle] FILE v137 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v116-file-v137");
      if (window.console && console.info){
