/* AROIDPEDIA footer bundle — built 2026-09-01 from FILE v206 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v206";
  if (window.console && console.info) console.info("[footer bundle] FILE v206 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v42-file-v206";
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v206");
      if (window.console && console.info){
