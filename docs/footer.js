/* AROIDPEDIA footer bundle — built 2026-08-31 from FILE v199 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v199";
  if (window.console && console.info) console.info("[footer bundle] FILE v199 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v35-file-v199";
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v199");
      if (window.console && console.info){
