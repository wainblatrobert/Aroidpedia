/* AROIDPEDIA footer bundle — built 2026-08-23 from FILE v165 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v165";
  if (window.console && console.info) console.info("[footer bundle] FILE v165 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v137-file-v165");
      if (window.console && console.info){
