/* AROIDPEDIA footer bundle — built 2026-08-26 from FILE v176 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v176";
  if (window.console && console.info) console.info("[footer bundle] FILE v176 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v145-file-v176");
      if (window.console && console.info){
