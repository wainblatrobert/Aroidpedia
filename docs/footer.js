/* AROIDPEDIA footer bundle — built 2026-09-01 from FILE v207 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v207";
  if (window.console && console.info) console.info("[footer bundle] FILE v207 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v207");
      if (window.console && console.info){
