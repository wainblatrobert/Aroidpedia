/* AROIDPEDIA footer bundle — built 2026-08-20 from FILE v120 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v120";
  if (window.console && console.info) console.info("[footer bundle] FILE v120 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v102-file-v120");
      if (window.console && console.info){
