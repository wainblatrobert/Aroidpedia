/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v153 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v153";
  if (window.console && console.info) console.info("[footer bundle] FILE v153 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v131-file-v153");
      if (window.console && console.info){
