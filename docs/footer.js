/* AROIDPEDIA footer bundle — built 2026-08-15 from FILE v63 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v63";
  if (window.console && console.info) console.info("[footer bundle] FILE v63 (hosted footer.js)");
...
(function(){
  ...
  function render(host, genus, shapes, geo, g){
    ...
    function setHot(zone){
      ...
      hover.appendChild(em);
      hover.appendChild(document.createTextNode(" · " + gr.count +
    ...
    function apply(view){
      ...
      order.forEach(function(z){
        var gr = groupMap[z];
        paths[z].style.fillOpacity = view === "range" ? 0.8 : ramp(gr.count, max);
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v49-file-v63");
      if (window.console && console.info){
