/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v97 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v97";
  if (window.console && console.info) console.info("[footer bundle] FILE v97 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v79-file-v97");
      if (window.console && console.info){
