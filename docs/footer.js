/* AROIDPEDIA footer bundle — built 2026-08-23 from FILE v164 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v164";
  if (window.console && console.info) console.info("[footer bundle] FILE v164 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v13-file-v164";
  ...
  function render(host, genus, shapes, geo, g, hier){
    ...
    function apply(view){
      ...
      Object.keys(groupMap).forEach(function(z){
        ...
        var c = (subView && PARENTS[z]) ? residuals()[z] : groupMap[z].count;
        if (c > max) max = c;
      });
      order.forEach(function(z){
        var gr = groupMap[z];
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v137-file-v164");
      if (window.console && console.info){
