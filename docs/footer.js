/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v110 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v110";
  if (window.console && console.info) console.info("[footer bundle] FILE v110 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v92-file-v110");
      if (window.console && console.info){
