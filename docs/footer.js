/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v101 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v101";
  if (window.console && console.info) console.info("[footer bundle] FILE v101 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v83-file-v101");
      if (window.console && console.info){
