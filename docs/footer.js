/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v109 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v109";
  if (window.console && console.info) console.info("[footer bundle] FILE v109 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v91-file-v109");
      if (window.console && console.info){
