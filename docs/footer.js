/* AROIDPEDIA footer bundle — built 2026-08-21 from FILE v141 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v141";
  if (window.console && console.info) console.info("[footer bundle] FILE v141 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v120-file-v141");
      if (window.console && console.info){
