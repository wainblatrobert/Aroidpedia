/* AROIDPEDIA footer bundle — built 2026-08-31 from FILE v201 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v201";
  if (window.console && console.info) console.info("[footer bundle] FILE v201 (hosted footer.js)");
...
(function(){
  ...
  var VERSION = "apgm-v37-file-v201";
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v148-file-v201");
      if (window.console && console.info){
