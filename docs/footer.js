/* AROIDPEDIA footer bundle — built 2026-08-16 from FILE v75 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v75";
  if (window.console && console.info) console.info("[footer bundle] FILE v75 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v58-file-v75");
      if (window.console && console.info){
