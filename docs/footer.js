/* AROIDPEDIA footer bundle — built 2026-08-19 from FILE v115 by build-footer-bundle v1.
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v97-file-v115");
      if (window.console && console.info){
