/* AROIDPEDIA footer bundle — built 2026-08-18 from FILE v98 by build-footer-bundle v1.
...
(function(){
  ...
  window.__apFooterBundle = "v98";
  if (window.console && console.info) console.info("[footer bundle] FILE v98 (hosted footer.js)");
...
(function(){
  ...
  function boot(){
    ...
    mounts.forEach(function(mount){
      ...
      mount.setAttribute("data-apsc-version", "card-v80-file-v98");
      if (window.console && console.info){
