import fs from 'fs';
import { EDITS } from './edits-refine.mjs';

const SRC = 'G:/My Drive/PlantsV2/Aroidpedia/WEBSITE/Squarespace CSS/Footer injection 8.10.26 v1.txt';
const OUT = 'G:/My Drive/PlantsV2/Aroidpedia/WEBSITE/Squarespace CSS/Footer injection 8.10.26 v2.txt';
...
const checks = [
  ['FILE VERSION: v22', 1], ['FILE VERSION: v21', 0],
  ['SPECIES CARD  (v20)', 1],
  ['apsc-wide', 2],            /* JS create + CSS rule */
  ['wide().appendChild', 3],
  ['body.appendChild(section("More photos"', 0],
  ['apsc-runhead', 7],         /* JS x3 + CSS x4 */
  ['STICKY AT A GLANCE', 2],   /* file header + code comment; block header wraps */
  ['CLIMATE RANGE  v4', 1]
];
let cbad = 0;
...
if (ctl) { console.error('CONTROL CHARS IN OUTPUT:', ctl.length); cbad++; }
