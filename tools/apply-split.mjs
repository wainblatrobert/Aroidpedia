...
const SRC = 'G:/My Drive/PlantsV2/Aroidpedia/WEBSITE/Squarespace CSS/Footer injection 8.9.26 v7.txt';
const OUT = 'G:/My Drive/PlantsV2/Aroidpedia/WEBSITE/Squarespace CSS/Footer injection 8.10.26 v1.txt';
...
const checks = [
  ['FILE VERSION: v21', 1], ['FILE VERSION: v20', 0],
  ['SPECIES CARD  (v19)', 1],
  ['apsc-colmain', 6],
  ['colMain.appendChild(body)', 1],
  ['card.appendChild(body)', 0],
  ['apsc-balance-home', 0],
  ['restoreLast', 0],
  ['CLIMATE RANGE  v4', 1]
];
...
/* control-char scan (the template-literal lesson) */
