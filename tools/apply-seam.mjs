...
const SRC = 'G:/My Drive/PlantsV2/Aroidpedia/WEBSITE/Squarespace CSS/Footer injection 8.10.26 v3.txt';
const OUT = 'G:/My Drive/PlantsV2/Aroidpedia/WEBSITE/Squarespace CSS/Footer injection 8.10.26 v4.txt';
...
const checks = [
  ['FILE VERSION: v24', 1], ['FILE VERSION: v23', 0],
  ['SPECIES CARD  (v22)', 1],
  ['apsc-map::before', 1],
  ['font-size:16.5px', 1],
  ['font-size:14px', 2],       /* other components' own 14px, untouched */
  ['CLIMATE RANGE  v4', 1]
];
let cbad = 0;
