...
const URL = "https://www.aroidpedia.com/journal/amorphophallus-aberrans";
...
let served = 1;  /* LIVE run: no interception, the deployed bundle is under test */
...
ok(stamp === "card-v88-file-v106", `version under test = ${stamp}`);
